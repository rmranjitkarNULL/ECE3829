...
#
# Script generated by Vivado on Fri Feb 21 08:04:12 -0500 2025
# SW Build 5239630 on Fri Nov 08 22:35:27 MST 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : test_ALS_PMOD_BFM.sh
...
#
# Usage        : test_ALS_PMOD_BFM.sh
#                test_ALS_PMOD_BFM.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                test_ALS_PMOD_BFM.sh [-reset_run]
#                test_ALS_PMOD_BFM.sh [-reset_log]
#                test_ALS_PMOD_BFM.sh [-help]
#
...
# script info
echo -e "test_ALS_PMOD_BFM.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./test_ALS_PMOD_BFM.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L xpm -L uvm -L unisims_ver -L unimacro_ver -L secureip --snapshot test_ALS_PMOD_BFM xil_defaultlib.test_ALS_PMOD_BFM xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim test_ALS_PMOD_BFM -key {Behavioral:sim_1:Functional:test_ALS_PMOD_BFM} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb test_ALS_PMOD_BFM.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./test_ALS_PMOD_BFM.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: test_ALS_PMOD_BFM.sh [-help]\n\
Usage: test_ALS_PMOD_BFM.sh [-step]\n\
Usage: test_ALS_PMOD_BFM.sh [-lib_map_path]\n\
Usage: test_ALS_PMOD_BFM.sh [-reset_run]\n\
Usage: test_ALS_PMOD_BFM.sh [-reset_log]\n\
Usage: test_ALS_PMOD_BFM.sh [-keep_index]\n\
Usage: test_ALS_PMOD_BFM.sh [-noclean_files]\n\n\
